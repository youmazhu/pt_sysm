...
class StreamDetector(QObject):
    ...
    def __init__(self, model_path: str, stream_url: str, save_dir: str, conf: float = 0.5, iou: float = 0.45, result_manager=None, classes=None):
        super().__init__()
    ...
    def connect_stream(self) -> bool:
        try:
            ...
            try:
                ...
                self.allowed_ids = _normalize_classes(self.model, self.classes)
        ...
        while getattr(self, 'running', True) and not self._stop_event.is_set():
            ...
            try:
                ...
                if self.allowed_ids is not None:
                    track_kwargs["classes"] = self.allowed_ids
...
def detect_stream(model_path: str, stream_url: str, save_dir: str, conf: float = 0.5, iou: float = 0.45, result_manager=None, classes=None):
    ...
    detector = StreamDetector(model_path, stream_url, save_dir, conf, iou, result_manager, classes=classes)
